...
import { ListNews } from "@/components/Berita";
import { ContainerContent } from "@/components/Layout";
import { BreadCrumb, Footer, Navbar, Pagination } from "@/components/UI";
  ...
  return (
    <main>
      ...
      <ContainerContent
        ...
        title={`Halaman ${props.berita.paging.currentPage} | Berita STT Mandala Giri`}
      >
